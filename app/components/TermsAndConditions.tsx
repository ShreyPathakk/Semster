  ...
  return (
    ...
    >
      <View style={styles.content}>
        ...
        {/* 
          BELOW IS THE ENTIRE TERMS AND CONDITIONS TEXT, 
          WORD FOR WORD.
        */}
        ...
        <Text style={styles.paragraph}>
          We operate the mobile application Semster (the "App"), as well as any
          other related products and services that refer or link to these legal terms
          (the "Legal Terms") (collectively, the "Services").
        </Text>
        <Text style={styles.paragraph}>
          Semster is an innovative platform that connects students by matching them
          based on their semester schedules, year of study, and major. Whether
          you're looking to find study partners, join academic groups, or collaborate
          with classmates, Semster makes it easy to build meaningful connections
        ...
        <Text style={styles.paragraph}>
          ...
          upon posting or notifying you by Yet to be decided, as stated in the email
        ...
        <Text style={styles.bulletPoints}>1. OUR SERVICES</Text>
        <Text style={styles.bulletPoints}>2. INTELLECTUAL PROPERTY RIGHTS</Text>
        <Text style={styles.bulletPoints}>3. USER REPRESENTATIONS</Text>
        <Text style={styles.bulletPoints}>4. USER REGISTRATION</Text>
        <Text style={styles.bulletPoints}>5. PROHIBITED ACTIVITIES</Text>
        <Text style={styles.bulletPoints}>6. USER GENERATED CONTRIBUTIONS</Text>
        <Text style={styles.bulletPoints}>7. CONTRIBUTION LICENSE</Text>
        <Text style={styles.bulletPoints}>8. GUIDELINES FOR REVIEWS</Text>
        <Text style={styles.bulletPoints}>9. MOBILE APPLICATION LICENSE</Text>
        <Text style={styles.bulletPoints}>10. THIRD-PARTY WEBSITES AND CONTENT</Text>
        <Text style={styles.bulletPoints}>11. SERVICES MANAGEMENT</Text>
        <Text style={styles.bulletPoints}>12. PRIVACY POLICY</Text>
        <Text style={styles.bulletPoints}>13. COPYRIGHT INFRINGEMENTS</Text>
        <Text style={styles.bulletPoints}>14. TERM AND TERMINATION</Text>
        <Text style={styles.bulletPoints}>15. MODIFICATIONS AND INTERRUPTIONS</Text>
        <Text style={styles.bulletPoints}>16. GOVERNING LAW</Text>
        <Text style={styles.bulletPoints}>17. DISPUTE RESOLUTION</Text>
        <Text style={styles.bulletPoints}>18. CORRECTIONS</Text>
        <Text style={styles.bulletPoints}>19. DISCLAIMER</Text>
        <Text style={styles.bulletPoints}>20. LIMITATIONS OF LIABILITY</Text>
        <Text style={styles.bulletPoints}>21. INDEMNIFICATION</Text>
        <Text style={styles.bulletPoints}>22. USER DATA</Text>
        <Text style={styles.bulletPoints}>23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</Text>
        <Text style={styles.bulletPoints}>24. MISCELLANEOUS</Text>
        <Text style={styles.bulletPoints}>25. DATA HANDLING AND THIRD-PARTY INTEGRATION</Text>
        <Text style={styles.bulletPoints}>26. CONTACT US</Text>
        ...
        <Text style={styles.bulletPoints}>• access the Services; and</Text>
        <Text style={styles.bulletPoints}>• download or print a copy of any portion of the Content to which you have properly gained access,</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.subTitle}>Your submissions and contributions</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          transferable license to use the application on a device that utilizes the
        ...
        <Text style={styles.sectionTitle}>10. THIRD-PARTY WEBSITES AND CONTENT</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.sectionTitle}>11. SERVICES MANAGEMENT</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          Policy: Please visit your "Profile" tab and on the top right press the
          settings button to access.. By using the Services, you agree to be bound
          by our Privacy Policy, which is incorporated into these Legal Terms. Please
          be advised the Services are hosted in the United States. If you access the
        ...
        <Text style={styles.sectionTitle}>13. COPYRIGHT INFRINGEMENTS</Text>
        <Text style={styles.paragraph}>
          We respect the intellectual property rights of others. If you believe that any
          material available on or through the Services infringes upon any copyright
        ...
        <Text style={styles.subTitle}>Exceptions to Informal Negotiations and Arbitration</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>
          ...
          OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $100.00
        ...
        <Text style={styles.sectionTitle}>25. DATA HANDLING AND THIRD-PARTY INTEGRATION</Text>
        <Text style={styles.paragraph}>
          This application uses third-party services, including Supabase, to store and
          process user data. By using this application, you acknowledge that your
          data may be transmitted and stored by these services in compliance with
          their respective terms and conditions. The Company ensures reasonable
          steps to maintain data security but cannot guarantee the privacy policies of
